    ...
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
      ...
      <div className="flex flex-col gap-6">
        ...
        <Card>
          ...
          <div className="space-y-4">
            {/* Visa Card */}
            <div className="p-5 rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 text-white shadow-md">
            ...
            {/* Amex Card */}
            <div className="p-5 rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
              <div className="flex justify-between items-start mb-8">
